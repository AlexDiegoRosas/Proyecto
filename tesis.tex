...
\input{dedicatoria} %Inserta ldedicatoria
...
\authoredby{A}
\input{1_Literatura} %Inserta el capítulo 1
\authoredby{A}
\input{2_Problema} %Inserta el capítulo 2
\authoredby{A}
\input{3_Metodologia} %Inserta el capítulo 3
\authoredby{A}
\input{4_Resultados} %Inserta el capítulo 4

\cleardoublepage
\phantomsection
\addcontentsline{toc}{chapter}{\normalfont CONCLUSIONES}
\input{conclusiones} %Inserta conclusiones

\cleardoublepage
\phantomsection
\addcontentsline{toc}{chapter}{\normalfont RECOMENDACIONES}
\input{recomendaciones} %Inserta recomendaciones
...
\input{anexo1} %Inserta el anexo1
